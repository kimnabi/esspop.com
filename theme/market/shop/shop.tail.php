...
<div id="quick" class="tab_wr">
    ...
    <div class="tabs_con">
        ...
        <div class="qk_con" id="qk_cart">
            <div class="qk_con_wr">
            	<h3><a href="<?php echo G5_SHOP_URL; ?>/cart.php">cart</a></h3>
	            <div class="hdqk_wr">
        ...
        <div class="qk_con tabsList" id="qk_wish">
            <div class="qk_con_wr">
	            <h3><a href="<?php echo G5_SHOP_URL; ?>/wishlist.php">wishlist</a></h3>
	            <ul class="qk_prdli">
	            <?php
	            $sql = " select *
	            ...
	            if ($i == 0)
	                echo '<li class="empty_list">There are no archives.</li>';
	            ?>
	            </ul>
...
<div id="ft">
    <div id="ft_wr">
        <ul class="ft_ul">
            ...
            <li><a href="<?php echo get_pretty_url('content', 'privacy'); ?>">Privacy Policy</a></li>
            <li><a href="<?php echo get_device_change_url(); ?>">Mobile version</a></li>
        	<li class="ft_call">Service center 1234-5678</li>
        </ul>
	</div>
    ...
    <div class="ft_info">
	    ...
	    <span><b>Tin No.</b> <?php echo $default['de_admin_company_saupja_no']; ?></span>
...
<!--	    <span><b>통신판매업신고번호</b> <?php echo $default['de_admin_tongsin_no']; ?></span>
		...
		<?php if ($default['de_admin_buga_no']) echo '<span><b>Opening hours</b> '.$default['de_admin_buga_no'].'</span>'; ?> 
		<br><br>
