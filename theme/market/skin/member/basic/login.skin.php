...
<div id="mb_login" class="mbskin">
    <div class="mbskin_box">
        ...
        <fieldset id="login_fs">
            ...
            <label for="login_id" class="sound_only">member<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="member">
