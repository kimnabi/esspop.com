...
<div id="hd">
    ...
    <div id="hd_wrapper">
		...
		<div class="hd_sch_wr">
	        <fieldset id="hd_sch">
	            ...
	            <input type="text" name="q" value="<?php echo stripslashes(get_text(get_search_string($q))); ?>" id="sch_str" required placeholder="Please enter a search term">
    ...
    <div id="hd_menu">
		...
		<ul class="hd_menu">
            <li><a href="<?php echo shop_type_url(1); ?>">Hit product</a></li>
            <li><a href="<?php echo shop_type_url(2); ?>">Recommended products</a></li>
            <li><a href="<?php echo shop_type_url(3); ?>">new product</a></li>
            <li><a href="<?php echo shop_type_url(4); ?>">popular item</a></li>
            <li><a href="<?php echo shop_type_url(5); ?>">Discount product</a></li>
        </ul>
    </div>
</div>
<!-- } 상단 끝 -->
...
<div id="side_menu">
	<ul id="quick">
		<li><button class="btn_sm_cl1 btn_sm"><i class="fa fa-user-o" aria-hidden="true"></i><span class="qk_tit">My Menu</span></button></li>
		<li><button class="btn_sm_cl2 btn_sm"><i class="fa fa-archive" aria-hidden="true"></i><span class="qk_tit">viewed today</span></button></li>
		<li><button class="btn_sm_cl3 btn_sm"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="qk_tit">cart</span></button></li>
		<li><button class="btn_sm_cl4 btn_sm"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="qk_tit">wish list</span></button></li>
    </ul>
	    ...
	    <div class="side_mn_wr1 qk_con">
	    	<div class="qk_con_wr">
		        ...
		        <ul class="side_tnb">
		            ...
		            <?php } ?>
					<li><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php">Order History</a></li>
					<li><a href="<?php echo G5_BBS_URL ?>/faq.php">FAQ</a></li>
		            <li><a href="<?php echo G5_BBS_URL ?>/qalist.php">1:1 inquiry</a></li>
		            ...
		            <li><a href="<?php echo G5_SHOP_URL; ?>/couponzone.php">Coupon Zone</a></li>
		        </ul>
