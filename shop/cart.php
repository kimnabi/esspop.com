...
<div id="sod_bsk" class="od_prd_list">
    ...
    <div class="tbl_head03 tbl_wrap">
        ...
        <tr>
            <th scope="col" class="chk_box">
                ...
                <label for="ct_all"><span></span><b class="sound_only">All products</b></label>
            </th>
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            if($it_options) {
                $mod_options = '<div class="sod_option_btn"><button type="button" class="mod_options">Modify option</button></div>';
        ...
        <tr>
            <td class="td_chk chk_box">
            	...
            	<label for="ct_chk_<?php echo $i; ?>"><span></span><b class="sound_only">product</b></label>
            </td>
        ...
        <div class="btn_cart_del">
            <button type="button" onclick="return form_check('seldelete');">Select Delete</button>
    ...
    <div id="sod_bsk_tot">
        <ul>
            <li class="sod_bsk_dvr">
                ...
                <strong><?php echo number_format($send_cost); ?></strong> php
            </li>
            ...
            <li class="sod_bsk_cnt">
                ...
                <strong><?php echo number_format($tot_price); ?></strong> php
            </li>
        </ul>
    </div>
    <?php } ?>
    ...
    <div id="sod_bsk_act">
        ...
        <a href="<?php echo shop_category_url($continue_ca_id); ?>" class="btn01">Continue shopping</a>
...
function fsubmit_check(f) {
    if($("input[name^=ct_chk]:checked").length < 1) {
        alert("Please select one or more products to purchase.");
        return false;
    }
...
function form_check(act) {
    ...
    {
        if($("input[name^=ct_chk]:checked").length < 1) {
            alert("Please select one or more products to order.");
            return false;
        }
