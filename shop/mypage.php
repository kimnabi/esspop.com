...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <dl class="cou_pt">
            ...
            <dt>Holding Coupon</dt>
            <dd><a href="<?php echo G5_SHOP_URL; ?>/coupon.php" target="_blank" class="win_coupon"><?php echo number_format($cp_count); ?></a></dd>
        </dl>
        <div id="smb_my_act">
            <ul>
                <?php if ($is_admin == 'super') { ?><li><a href="<?php echo G5_ADMIN_URL; ?>/" class="btn_admin">admin</a></li><?php } ?>
                <li><a href="<?php echo G5_BBS_URL; ?>/memo.php" target="_blank" class="win_memo btn01">Inbox</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php" class="btn01">Member information modification</a></li>
    ...
    <section id="smb_my_wish">
        ...
        <div class="list_02">
            ...
            if ($i == 0)
                echo '<li class="empty_li">There are no archives.</li>';
            ?>
            </ul>
        </div>
...
{
    return confirm('Do you really want to withdraw from membership?')
}
</script>
<!-- } 마이페이지 끝 -->
