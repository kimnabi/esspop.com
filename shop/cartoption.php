...
<h2>Product Option Modification</h2>
<!-- 장바구니 옵션 시작 { -->
...
<div class="btn_confirm">
    ...
    <button type="button" id="mod_option_close" class="btn_close"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only">close</span></button>
</div>
</form>
