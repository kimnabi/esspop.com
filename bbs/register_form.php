...
if ($w == "") {
    ...
    if (!isset($_POST['agree']) || !$_POST['agree']) {
        alert('You must agree to the terms and conditions of membership in order to register as a member. ', G5_BBS_URL.'/register.php');
    }
    ...
    */
    ...
    alert('The w value was not passed properly.');
}
